...
module.exports = class TeoDB extends Base {
     ...
     */
    createAdapter() {
        this.adapterInstance = new this.Adapter({
            // some inner adapters, if needed
            adapters: this.adapterConfig.adapters,
            // Connections Config
            // Setup connections using the named adapter configs
            connections: this.adapterConfig.connections
        });
     ...
     */
    * connect() {
        yield* this.getAdapterInstance().connect();
    }
     ...
     */
    * disconnect() {
        yield* this.getAdapterInstance().disconnect();
    }
     ...
     */
    isConnected() {
        return this.getAdapterInstance().isConnected();
    }
